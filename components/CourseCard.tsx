...
export default function CourseCard({
  ...
  >
    <div
      className={`w-[600px] h-[350px] rounded-2xl bg-white p-5 shadow-[0_12px_40px_rgba(0,0,0,0.12) ]
      cursor-pointer transition-transform hover:scale-[1.01] hover:shadow-[0_20px_60px_rgba(0,0,0,0.15)]
      ${className}`}
    >
